...
export default function intro() {
  return (
    <div className='text-center'>
        ...
        <p>
            <br/><br/>
            SecureGuard is a security management system that helps you track security logs from your camera. <br/>
        ...
        <ol className="list-decimal">
            <li>Go to the <b>Vision</b> page (can be found in the navigation bar) to view your camera feeds. <br/></li>
